...
class KakaoLogin {
  ...
  getLoginUrl (socialKakaoClientId, socialKakaoClientSecret, socialKakaoRedirect) {
    ...
    const kakaoLoginUrl = `https://kauth.kakao.com/oauth/authorize?client_id=${this.socialKakaoClientId}&redirect_uri=${this.socialKakaoRedirect}&response_type=code&scopes=account_email,name`;
